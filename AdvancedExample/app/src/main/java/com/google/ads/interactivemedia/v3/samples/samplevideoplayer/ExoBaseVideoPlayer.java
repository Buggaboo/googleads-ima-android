...
public class ExoBaseVideoPlayer extends Fragment implements OnClickListener, ExoPlayer.EventListener,
...
/*
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // TODO add layouts player_activity.xml
...
*/
    ...
    */
    ...
    protected void initializePlayer() {
        // TODO replace with getArguments()
        ...
        if (playerNeedsSource) {
            // TODO convert this to bundle String in the #setArguments
            //String action = args.getAction();
            Uri[] uris;
            String[] extensions;
            if (bundleKeySet.contains(URI_EXTRA) && bundleKeySet.contains(EXTENSION_EXTRA)) {
                uris = new Uri[]{(Uri) args.getSerializable(URI_EXTRA)};
                extensions = new String[]{args.getString(EXTENSION_EXTRA)};
            }else if (bundleKeySet.contains(URI_LIST_EXTRA) && bundleKeySet.contains(EXTENSION_LIST_EXTRA)) {
